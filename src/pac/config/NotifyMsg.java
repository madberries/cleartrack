...
public class NotifyMsg {
  ...
  /**
   * @param description The Api method description WITHOUT return type and WITHOUT parameter
   *        identifiers ex. "Runtime.exec(String, String[], File)".
   */
  ...
  /**
   * Call this method: After altering untrusted data When action is exception of terminate, just
   * before calling Notify.notifyAndRespond().
   * 
   * @param msg
   */
  ...
  /**
   * Call this method after addTaintOutput() to mark the offending line in the output that was
   * previously added.
   * 
  ...
  /**
   * Call this method immediately before calling Notify.notifyAndRespond when action is either
