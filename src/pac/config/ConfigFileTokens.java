...
public class ConfigFileTokens {
  ...
  public static final String UNTRUSTED_KEY_CAN_ACCESS_PROPERTY_TKN =
      "untrusted_key_can_access_property";
  ...
  public static final String CAN_SET_CATALOG_WITH_UNTRUSTED_DATA_TKN =
      "can_set_catalog_with_untrusted_data";
  public static final String CAN_SET_CATALOG_WITH_UNTRUSTED_PROPERTIES_TKN =
      "can_set_clientinfo_with_untrusted_properties";
  public static final String CAN_SET_CATALOG_WITH_UNTRUSTED_NAME_OR_VALUE_TKN =
      "can_set_clientinfo_with_untrusted_name_or_value";
  public static final String CAN_SET_SAVEPOINT_WITH_UNTRUSTED_NAME_TKN =
      "can_set_savepoint_with_untrusted_name";
  public static final String CAN_SET_TYPEMAP_WITH_UNTRUSTED_MAP_TKN =
