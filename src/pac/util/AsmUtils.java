...
public class AsmUtils {
     ...
     * 
     * @param owner
     *            String of the owner classname (internal form).
     * @param origFieldName
     ...
     * @param flags
     *            int of the flags to check for in modifier
     ...
     * @param type
     *            Type of the object in question.
     * @return true if and only if the type is exactly one of Object, Object[],
     *         Object[][], Object[][][], etc...
     */
    ...
    /**
     * Converts the supplied Type object to a new Type object that represents
     * the primitive array taint type.
     * 
     * @param type
    ...
    /**
     * Converts the supplied Type object to a new Type object that represents
     * the primitive taint type (or primitive array taint type in the event that
     * the supplied type is a primitive array).
     * 
     * @param type
     *            Type of the original object
     * @return Type.INT_TYPE (in the case of a primitive type), the primitive
     *         array taint wrapper type (for primitive arrays), otherwise null.
     */
