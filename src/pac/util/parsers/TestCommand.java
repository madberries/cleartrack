...
public class TestCommand extends Parser {
  public static final String[] tokenNames = new String[] {"<invalid>", "<EOR>", "<DOWN>", "<UP>",
      "COMMENT", "DECIMAL_LITERAL", "DIGIT", "DOLLAR", "DOT", "DOUBLE_DOT", "DOUBLE_QUOTE", "GT",
      "LEFT_PAREN", "LETTER", "MINUS", "NAME", "PATH", "PLUS", "QUOTE", "RIGHT_PAREN",
      "STRING_LITERAL", "Semicolon", "TILDA", "UNDERSCORE", "VERTICAL_BAR", "WS"};
