...
public class TestLang extends Parser implements LangConstants {
  public static final String[] tokenNames = new String[] {"<invalid>", "<EOR>", "<DOWN>", "<UP>",
      "AMPERSAND", "APPROX", "AT", "CHAR_NO_DOUBLE_QUOTE", "CHAR_NO_QUOTE", "CIRCUMFLEX", "COLON",
      "COLON_EQ", "COMMA", "COMMENT_SQL", "COMMENT_XQUERY", "DECIMAL_LITERAL", "DIGIT", "DOLLAR",
      "DOT", "DOUBLE_DOT", "DOUBLE_GT", "DOUBLE_LT", "DOUBLE_QUOTE", "DOUBLE_SLASH", "EQ",
      "EXCLAMATION", "EXCLAMATION_EQ", "GE", "GT", "HEX_DIGIT", "IDENTIFIER", "IDENTIFIER_CONTINUE",
      "IDENTIFIER_START", "KW_SQL_ALL", "KW_SQL_ALTER", "KW_SQL_BY", "KW_SQL_CREATE",
      "KW_SQL_DATABASE", "KW_SQL_DELETE", "KW_SQL_DISTINCT", "KW_SQL_DROP", "KW_SQL_FROM",
      "KW_SQL_INDEX", "KW_SQL_INSERT", "KW_SQL_INTO", "KW_SQL_ORDER", "KW_SQL_SELECT", "KW_SQL_SET",
      "KW_SQL_TABLE", "KW_SQL_TRUNCATE", "KW_SQL_UNIQUE", "KW_SQL_UPDATE", "KW_SQL_VALUES",
      "KW_SQL_VIEW", "KW_SQL_WHERE", "KW_XQUERY_ANCESTOR_COLON", "KW_XQUERY_ANCESTOR_OR_SELF_COLON",
      "KW_XQUERY_AND", "KW_XQUERY_AS", "KW_XQUERY_ATTRIBUTE_COLON", "KW_XQUERY_BASE_URI",
      "KW_XQUERY_BOUNDARY_SPACE", "KW_XQUERY_CASE", "KW_XQUERY_CAST", "KW_XQUERY_CASTABLE",
      "KW_XQUERY_CHILD_COLON", "KW_XQUERY_COMMENT", "KW_XQUERY_CONSTRUCTION",
      "KW_XQUERY_COPY_NAMESPACES", "KW_XQUERY_DECLARE", "KW_XQUERY_DEFAULT",
      "KW_XQUERY_DESCENDANT_COLON", "KW_XQUERY_DESCENDANT_OR_SELF_COLON", "KW_XQUERY_DIV",
      "KW_XQUERY_DOCNODE", "KW_XQUERY_ELEMENT", "KW_XQUERY_ELSE", "KW_XQUERY_EMPTY_SEQUENCE",
      "KW_XQUERY_EQ", "KW_XQUERY_EVERY", "KW_XQUERY_EXCEPT", "KW_XQUERY_FOLLOWING_COLON",
      "KW_XQUERY_FOLLOWING_SIBLING_COLON", "KW_XQUERY_FOR", "KW_XQUERY_FUNCTION", "KW_XQUERY_GE",
      "KW_XQUERY_GT", "KW_XQUERY_IDIV", "KW_XQUERY_IF", "KW_XQUERY_IMPORT", "KW_XQUERY_IN",
      ...
      "KW_XQUERY_NAMESPACE_COLON", "KW_XQUERY_NE", "KW_XQUERY_NODE", "KW_XQUERY_OF",
      "KW_XQUERY_OPTION", "KW_XQUERY_OR", "KW_XQUERY_ORDERING", "KW_XQUERY_PARENT_COLON",
      "KW_XQUERY_PRECEDING_COLON", "KW_XQUERY_PRECEDING_SIBLING_COLON",
      "KW_XQUERY_PROCESSING_INSTRUCTION", "KW_XQUERY_RETURN", "KW_XQUERY_SATISFIES",
      "KW_XQUERY_SCHEMA", "KW_XQUERY_SCHEMA_ATTR", "KW_XQUERY_SCHEMA_ELEM", "KW_XQUERY_SELF_COLON",
      "KW_XQUERY_SOME", "KW_XQUERY_TEXT", "KW_XQUERY_THEN", "KW_XQUERY_TO", "KW_XQUERY_TREAT",
      "KW_XQUERY_TYPESWITCH", "KW_XQUERY_UNION", "KW_XQUERY_VALIDATE", "KW_XQUERY_VARIABLE",
      ...
      "OCTAL_OR_HEX_LITERAL", "PERCENT", "PLUS", "POUND_SIGN", "QUESTION_MARK", "QUOTE",
      "RIGHT_BRACE", "RIGHT_BRACKET", "RIGHT_PAREN", "RIGHT_PAREN_POUND_SIGN", "SEMICOLON", "SLASH",
      "STAR", "STRING_LITERAL", "UNDERSCORE", "VERTICAL_BAR", "WS"};
  ...
  public final void testSQLCreate(int targets) {
    ...
    if (input.LA(2) == KW_SQL_TABLE || input.LA(2) == KW_SQL_VIEW
        || (input.LA(2) == KW_SQL_UNIQUE && input.LA(3) == KW_SQL_INDEX)
        || input.LA(2) == KW_SQL_INDEX || input.LA(2) == KW_SQL_DATABASE) {
      result = SQL;
    }
  }
