...
public class TestLangLexer extends Lexer {
  ...
  public final void mSTRING_LITERAL() throws RecognitionException {
    try {
      ...
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // TestLang.g:235:5: ( QUOTE ( '\\\\' QUOTE | QUOTE QUOTE | CHAR_NO_QUOTE )* QUOTE |
      // DOUBLE_QUOTE ( DOUBLE_QUOTE DOUBLE_QUOTE | CHAR_NO_DOUBLE_QUOTE )* DOUBLE_QUOTE )
      int alt3 = 2;
      ...
      switch (alt3) {
        ...
        // TestLang.g:235:7: QUOTE ( '\\\\' QUOTE | QUOTE QUOTE | CHAR_NO_QUOTE )* QUOTE
        {
          ...
          break;
        case 2:
        // TestLang.g:237:4: DOUBLE_QUOTE ( DOUBLE_QUOTE DOUBLE_QUOTE | CHAR_NO_DOUBLE_QUOTE )*
        // DOUBLE_QUOTE
        {
          mDOUBLE_QUOTE();
          if (state.failed)
  ...
  public final void mDECIMAL_LITERAL() throws RecognitionException {
    try {
      ...
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // TestLang.g:255:5: ( ( ( ( DOT ( DIGIT )+ ) | ( DIGIT )+ ( DOT ( DIGIT )* )? ) ( ( 'f' | 'F'
      // ) | ( 'd' | 'D' ) | ( 'e' | 'E' ) ( PLUS | MINUS )? ( DIGIT )+ )? ) )
      // TestLang.g:255:9: ( ( ( DOT ( DIGIT )+ ) | ( DIGIT )+ ( DOT ( DIGIT )* )? ) ( ( 'f' | 'F' )
      // | ( 'd' | 'D' ) | ( 'e' | 'E' ) ( PLUS | MINUS )? ( DIGIT )+ )? )
      {
        // TestLang.g:255:9: ( ( ( DOT ( DIGIT )+ ) | ( DIGIT )+ ( DOT ( DIGIT )* )? ) ( ( 'f' | 'F'
        // ) | ( 'd' | 'D' ) | ( 'e' | 'E' ) ( PLUS | MINUS )? ( DIGIT )+ )? )
        // TestLang.g:255:10: ( ( DOT ( DIGIT )+ ) | ( DIGIT )+ ( DOT ( DIGIT )* )? ) ( ( 'f' | 'F'
        // ) | ( 'd' | 'D' ) | ( 'e' | 'E' ) ( PLUS | MINUS )? ( DIGIT )+ )?
        {
          ...
          // TestLang.g:257:9: ( ( 'f' | 'F' ) | ( 'd' | 'D' ) | ( 'e' | 'E' ) ( PLUS | MINUS )? (
          // DIGIT )+ )?
          int alt11 = 4;
          switch (input.LA(1)) {
            case 'F':
  ...
  public final void mIDENTIFIER_START() throws RecognitionException {
    try {
      // TestLang.g:295:2: ( LETTER | UNDERSCORE | ( '\\u00C0' .. '\\u00D6' ) | ( '\\u00D8' ..
      // '\\u00F6' ) | ( '\\u00F8' .. '\\u02FF' ) | ( '\\u0370' .. '\\u037D' ) | ( '\\u037F' ..
      // '\\u1FFF' ) | ( '\\u200C' .. '\\u200D' ) | ( '\\u2070' .. '\\u218F' ) | ( '\\u2C00' ..
      // '\\u2FEF' ) | ( '\\u3001' .. '\\uD7FF' ) | ( '\\uF900' .. '\\uFDCF' ) | ( '\\uFDF0' ..
      // '\\uFFFD' ) )
  ...
  public final void mIDENTIFIER_CONTINUE() throws RecognitionException {
    try {
      // TestLang.g:299:2: ( IDENTIFIER_START | DOT | DIGIT | '\\u00B7' | '\\u0300' .. '\\u036F' |
      // '\\u203F' .. '\\u2040' )
      int alt18 = 6;
  ...
  public void mTokens() throws RecognitionException {
    // TestLang.g:1:8: ( KW_SQL_ALL | KW_SQL_ALTER | KW_SQL_BY | KW_SQL_CREATE | KW_SQL_DATABASE |
    // KW_SQL_DELETE | KW_SQL_DISTINCT | KW_SQL_DROP | KW_SQL_FROM | KW_SQL_INDEX | KW_SQL_INSERT |
    // KW_SQL_INTO | KW_SQL_ORDER | KW_SQL_SELECT | KW_SQL_SET | KW_SQL_TABLE | KW_SQL_TRUNCATE |
    // KW_SQL_UNIQUE | KW_SQL_UPDATE | KW_SQL_VALUES | KW_SQL_VIEW | KW_SQL_WHERE | KW_XQUERY_AND |
    // KW_XQUERY_AS | KW_XQUERY_BASE_URI | KW_XQUERY_BOUNDARY_SPACE | KW_XQUERY_CASE |
    // KW_XQUERY_CAST | KW_XQUERY_CASTABLE | KW_XQUERY_COMMENT | KW_XQUERY_CONSTRUCTION |
    // KW_XQUERY_COPY_NAMESPACES | KW_XQUERY_DECLARE | KW_XQUERY_DEFAULT | KW_XQUERY_DIV |
    // KW_XQUERY_DOCNODE | KW_XQUERY_ELEMENT | KW_XQUERY_ELSE | KW_XQUERY_EMPTY_SEQUENCE |
    // KW_XQUERY_EQ | KW_XQUERY_EVERY | KW_XQUERY_EXCEPT | KW_XQUERY_FOR | KW_XQUERY_FUNCTION |
    // KW_XQUERY_GE | KW_XQUERY_GT | KW_XQUERY_IDIV | KW_XQUERY_IF | KW_XQUERY_IMPORT | KW_XQUERY_IN
    // | KW_XQUERY_INSTANCE | KW_XQUERY_INTERSECT | KW_XQUERY_IS | KW_XQUERY_ITEM | KW_XQUERY_LE |
    // KW_XQUERY_LET | KW_XQUERY_LT | KW_XQUERY_MOD | KW_XQUERY_MODULE | KW_XQUERY_NAMESPACE |
    // KW_XQUERY_NE | KW_XQUERY_NODE | KW_XQUERY_OF | KW_XQUERY_OPTION | KW_XQUERY_OR |
    // KW_XQUERY_ORDERING | KW_XQUERY_PROCESSING_INSTRUCTION | KW_XQUERY_RETURN |
    // KW_XQUERY_SATISFIES | KW_XQUERY_SCHEMA | KW_XQUERY_SCHEMA_ATTR | KW_XQUERY_SCHEMA_ELEM |
    // KW_XQUERY_SOME | KW_XQUERY_TEXT | KW_XQUERY_THEN | KW_XQUERY_TO | KW_XQUERY_TREAT |
    // KW_XQUERY_TYPESWITCH | KW_XQUERY_UNION | KW_XQUERY_VARIABLE | KW_XQUERY_VALIDATE |
    // KW_XQUERY_VERSION | KW_XQUERY_XQUERY | KW_XQUERY_ANCESTOR_COLON |
    // KW_XQUERY_ANCESTOR_OR_SELF_COLON | KW_XQUERY_ATTRIBUTE_COLON | KW_XQUERY_CHILD_COLON |
    // KW_XQUERY_DESCENDANT_COLON | KW_XQUERY_DESCENDANT_OR_SELF_COLON | KW_XQUERY_FOLLOWING_COLON |
    // KW_XQUERY_FOLLOWING_SIBLING_COLON | KW_XQUERY_NAMESPACE_COLON | KW_XQUERY_PARENT_COLON |
    // KW_XQUERY_PRECEDING_COLON | KW_XQUERY_PRECEDING_SIBLING_COLON | KW_XQUERY_SELF_COLON |
    // LEFT_PAREN | RIGHT_PAREN | STAR | EQ | LE | GE | VERTICAL_BAR | AMPERSAND | LT | GT |
    // SEMICOLON | COLON | PLUS | MINUS | LEFT_BRACKET | RIGHT_BRACKET | LEFT_BRACE | RIGHT_BRACE |
    // COMMA | DOT | SLASH | QUESTION_MARK | EXCLAMATION | APPROX | LT_GT | PERCENT | CIRCUMFLEX |
    // POUND_SIGN | DOUBLE_SLASH | DOUBLE_DOT | DOUBLE_LT | DOUBLE_GT | EXCLAMATION_EQ | COLON_EQ |
    // LT_EXCLAMATION | LEFT_PAREN_POUND_SIGN | RIGHT_PAREN_POUND_SIGN | AT | DOLLAR |
    // STRING_LITERAL | DECIMAL_LITERAL | OCTAL_OR_HEX_LITERAL | IDENTIFIER | COMMENT_SQL |
    // COMMENT_XQUERY | WS )
    int alt26 = 142;
  ...
  static final String DFA26_eotS =
      "\1\uffff\24\63\1\164\3\uffff\1\171\1\174\3\uffff\1\176\1\uffff\1"
          + "\u0080\5\uffff\1\u0082\1\u0084\1\uffff\1\u0086\3\uffff\1\u0088\3"
          ...
          + "\2\63\1\uffff\2\63\4\uffff\1\u020b\2\uffff\1\63\2\uffff\1\63\4\uffff"
          + "\1\u020e\1\uffff";
  static final String DFA26_eofS = "\u020f\uffff";
  static final String DFA26_minS =
      "\1\11\1\154\3\141\1\157\1\144\1\146\2\141\1\156\1\141\1\150\1\154"
          ...
          + "\1\55\1\uffff\1\157\1\55\4\uffff\1\56\2\uffff\1\55\2\uffff\1\156"
          + "\4\uffff\1\56\1\uffff";
  static final String DFA26_maxS =
      "\1\ufffd\1\164\1\171\2\162\1\165\1\164\1\162\1\157\1\171\1\160\1"
  ...
  static final String DFA26_acceptS =
      "\26\uffff\1\142\1\143\1\144\2\uffff\1\147\1\150\1\153\1\uffff\1"
          ...
          + "\1\64\1\105\1\uffff\1\134\1\74\1\uffff\1\136\1\137\1\uffff\1\130"
          + "\1\131\1\116\1\103\1\uffff\1\37";
  ...
  static final String[] DFA26_transitionS = {
      ...
      "\1\100\3\uffff\1\101\3\uffff\1\102\5\uffff\1\104\2\uffff\1" + "\103",
      "\1\106\2\uffff\1\105\2\uffff\1\107",
      "\1\111\1\uffff\1\112\6\uffff\1\113\1\110\4\uffff\1\114\1\115",
      "\1\117\11\uffff\1\120\1\uffff\1\116", "\1\122\1\uffff\1\123\1\uffff\1\121\11\uffff\1\124",
      "\1\125\3\uffff\1\127\2\uffff\1\130\6\uffff\1\131\2\uffff\1" + "\126\6\uffff\1\132",
      "\1\133\1\uffff\1\134", "\1\135\3\uffff\1\137\3\uffff\1\136", "\1\140",
      "\1\141\1\142\3\uffff\1\143\4\uffff\1\144\1\uffff\1\145", "\1\146\16\uffff\1\147",
      "\1\150\16\uffff\1\151", "\1\152", "\1\153\3\uffff\1\154\11\uffff\1\155",
      "\1\157\20\uffff\1\156", "\1\160", "\1\161", "\1\162\26\uffff\1\163", "", "", "",
      "\1\170\32\uffff\1\167\1\165\1\166", "\1\172\1\173", "", "", "", "\1\175", "", "\1\177", "",
      "", "", "", "", "\1\u0081\1\uffff\12\62", "\1\177\4\uffff\1\u0083", "", "\1\u0085", "", "",
      "", "\1\u0087", "", "", "", "\1\u0089\7\u008b\40\uffff\1\u008a", "", "", "",
      "\1\u008c\7\uffff\1\u008d", "\1\u008f\1\u008e",
      ...
      "\1\63\1\uffff\12\63\7\uffff\32\63\4\uffff\1\63\1\uffff\32\63"
          ...
          + "\63\u0a70\uffff\u03f0\63\21\uffff\ua7ff\63\u2100\uffff\u04d0"
          + "\63\40\uffff\u020e\63",
      "\1\u0104", "\1\u0105", "\1\u0106", "\1\u0107", "\1\u0108", "\1\u0109", "\1\u010a",
      "\1\u010b", "", "\1\u010c", "\1\u010e\1\uffff\1\u010d", "\1\u010f",
      "\1\u0111\13\uffff\1\u0110", "\1\u0112", "\1\u0113", "\1\u0114", "\1\u0115", "\1\u0116",
      "\1\u0117", "\1\u0118", "", "\1\u0119", "\1\u011a", "", "",
      "\1\63\1\uffff\12\63\7\uffff\32\63\4\uffff\1\63\1\uffff\32\63"
          + "\74\uffff\1\63\10\uffff\27\63\1\uffff\37\63\1\uffff\u0286\63"
          + "\1\uffff\u1c81\63\14\uffff\2\63\61\uffff\2\63\57\uffff\u0120"
