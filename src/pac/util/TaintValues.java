...
public final class TaintValues {
    ...
    /*
     * We can save an extra bit by assigning the following values to taint
     * levels. Trusted should be zero, since any uninitialized value should be
     * assumed trusted. Also, consider each case.
     * 
     *      Tr Ta Un
     *      -- -- --
     * Tr | Tr Ta Un
     ...
     * Un | Un Ta Un
     * 
     * Therefore the only possible valid assignments for each trust level is
     * Tr = 0, Un = 1, Ta = 3 (under bitwise-or).
     */
    ...
    /**
     * 
     * Converts a taint array to a nice printable string.  The first row of characters
     * represents the input type and the second row of characters represents the
     * taint bits.<br/>
     * 
     * <h3><u>taint row:</u></h3>
     * <table>
     ...
     * @param offset int
     * @param length int
     * @return String representation of taint
     */
