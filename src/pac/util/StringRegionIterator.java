...
/**
 * Convenience class for iterating over taint regions of a string (over the character array).
 * 
 * @author jeikenberry
 */
public class StringRegionIterator implements Iterator<StringRegionIterator.StringRegion> {
  ...
  /**
   * Constructs an iterator of StringRegions with no taint regions masked out.
   * 
   * @param str
   */
  ...
  /**
   * Constructs an iterator of StringRegions with the specified mask applied to the taint.
   * 
   * @param str
   * @param mask
   */
