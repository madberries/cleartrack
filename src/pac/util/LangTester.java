...
public class LangTester implements LangConstants {
  ...
  /**
   * Given a string, tests whether the string is a command, an LDAP expression, an SQL statement, an
   * XQuery expression, or unknown. Returns an integer code for the resulting language or unknown.
   * 
  ...
  /**
   * Given a string, tests whether the string represents a command, an LDAP expression, an SQL
   * statement, an XQuery expression, or unknown. Prints the test result to the console.
   */
