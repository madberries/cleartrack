/**
 * JLibs: Common Utilities for Java Copyright (C) 2009 Santhosh Kumar T <santhosh.tekuri@gmail.com>
 *
 ...
 * 
 * <p>To print "hello ansi world" in bold with blue foreground and white background:</p>
 * 
 * <pre>
 ...
 * <b>Ansi Support:</b>
 * 
 * <p>Ansi might not be supported on all systems. Ansi is mostly supported by all unix operating
 * systems.</p>
 * 
 * <p>{@link Ansi#SUPPORTED} is a final boolean, that can be used to check whether your console
 * supports Ansi format;</p>
 * 
 * <p>Ansi class uses simple checks to decide whether ansi is supported or not. Sometimes it may do
 * wrong guess. In such cases you can override its decision using following system property:
 * <code>-DAnsi=true</code> or <code>-DAnsi=false</code> </p>
 * 
 * <p>If {@link Ansi#SUPPORTED} is false, any ansi method will not produce ansi control sequences. so
 * you can safely use: <code>ansi.out("hello ansi world")</code> irrespective of ansi is supported
 * or not. if ansi is not supported, this will simply do:
 * <code>System.out.print("hello ansi world")</code></p>
 * 
...
public class Ansi {
   ...
   * <p>
   * <br>
   * when this is false, it doesn't colorize given strings, rather than simply returns the given
   * strings
   * <p>
   * <br>
   * It tries best effort to guess whether ansi is supported or not. But you can override this value
   * using system property "Ansi" (-DAnsi=true/false)
   */
  public static final boolean SUPPORTED =
      Boolean.getBoolean("Ansi") || (OS.get().isUnix() && System.console() != null);
  ...
  /**
   * Output mechanism for transformations. This will flush all messages on the current thread's
   * class/jar file if flushMessages is true.
   * 
   * @param message String of the message log.
   * @param flushMessages boolean to flush all messages for the current thread to the console iff
   *        set to true.
  ...
  /**
   * Logs an error message for the current class being processed (denoted by className).
   * 
  ...
  /**
   * Logs an warning message for the current class being processed (denoted by className).
   * 
   * @param message String of the message to log.
   * @param className String class name of the current class being transformed.
   * @param args Object[] of the args to format into the message.
  ...
  /**
   * Logs a debug message for the current class being processed (denoted by className). These
   * messages will be filtered if verbose mode is disabled.
   * 
   * @param message String of the message to log.
   * @param className String class name of the current class being transformed.
   * @param args Object[] of the args to format into the message.
  ...
  private static void info(String message, String className, Ansi ansi, String level,
      Object... args) {
    ...
    synchronized (messageMap) {
      ...
      if (className == null) {
        ...
        messages.add(ansi
            .colorize(String.format(" " + level + " " + className + ": " + message + "\n", args)));
      }
    }
  }
