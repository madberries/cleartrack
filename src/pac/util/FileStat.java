...
/**
 * Native wrapper for fstat.  This class can also be used to acquire
 * the mimetype of a file (natively through libmagic).
 * 
 * @author jeikenberry
 */
public class FileStat {
    ...
    /**
     * The type of stat representing this object (i.e. stat, 
     * fstat, lstat).
     */
    ...
    /**
     * Determines the canonicalized path of a file.  This native routine is
     * necessary since Java apparently caches canonicalized file paths by
     * default.  They do eventually expire, however.
     * 
    ...
    /**
     * Obtains file stat information about a given file descriptor, through
     * a native call to fstat.
     * 
    ...
    /**
     * Obtains file lstat information about a given file descriptor, through
     * a native call to lstat.
     * 
     ...
     * 
     * @param file File
     * @return String of file's mimetype
    ...
    public String toString() {
        return "time-of-check: in method " + check + "\n        filename=" + checkedPath + "\n        realpath="
                + checkedRealpath + "\n        inode: " + inode + ", dev: " + dev + ", ctime: " + ctime + "."
                + ctime_nsec + ", type: " + type;
    }
    ...
    public String toString(File file) {
        ...
        try {
            ...
            return "time-of-use: in method " + check + "\n        filename=" + absPath + "\n        realpath=N/A"
                    + "\n        inode: " + inode + ", dev: " + dev + ", ctime: " + ctime + "." + ctime_nsec + ",type: "
                    + type;
        }
    }
    ...
    /**
     * Determines whether the set of permissions matches the mode of this
     * FileStat object by or-ing the bits of each value in this set and
     * comparing it with the mode of this FileStat object (masked with 0777).
     * 
    ...
    /**
     * Constructs a set of PosixFilePermissions from the mode of this
     * FileStat object.
     * 
