...
public enum InstrumentationLocation {
  ...
  /**
   * Apply to all methods for compatibility (instrumented and uninstrumented).
   */
  COMPAT,

  /**
   * Apply to all instrumented and uninstrumented application methods (for transparency).
   */
  TRANS
}
