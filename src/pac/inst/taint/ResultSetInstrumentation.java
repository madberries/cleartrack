...
public final class ResultSetInstrumentation {
  ...
  public static final URL getURL(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final String getString(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final InputStream getAsciiStream(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
    InputStream in = rs.getAsciiStream(columnIndex, columnIndex_t, ret);
    if (in == null)
      return null;
    in.ss_hasUniformTaint = true;
    in.ss_taint =
        (BaseConfig.getInstance().taintDbReads() ? TaintValues.TAINTED : TaintValues.TRUSTED)
            | TaintValues.DATABASE;
    return in;
  }

  @InstrumentationMethod
  public static final InputStream getAsciiStream(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @Deprecated
  @InstrumentationMethod
  public static final InputStream getUnicodeStream(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @Deprecated
  @InstrumentationMethod
  public static final InputStream getUnicodeStream(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
  ...
  @InstrumentationMethod
  public static final InputStream getBinaryStream(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final InputStream getBinaryStream(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
  ...
  @InstrumentationMethod
  public static final Reader getCharacterStream(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
  ...
  @InstrumentationMethod
  public static final Reader getCharacterStream(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final String getNString(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final Reader getNCharacterStream(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
  ...
  @InstrumentationMethod
  public static final Reader getNCharacterStream(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final ByteArrayTaint getBytes(ResultSet rs, int columnIndex, int columnIndex_t,
      Ret ret) throws SQLException {
  ...
  @InstrumentationMethod
  public static final ByteArrayTaint getBytes(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final int getInt(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final long getLong(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final float getFloat(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final float getFloat(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final byte getByte(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final boolean getBoolean(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final double getDouble(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final short getShort(ResultSet rs, int columnIndex, int columnIndex_t, Ret ret)
      throws SQLException {
  ...
  @InstrumentationMethod
  public static final short getShort(ResultSet rs, String columnLabel, Ret ret)
      throws SQLException {
