...
public final class ConstructorInstrumentation extends MemberInstrumentation {
    ...
    @InstrumentationMethod(inline = true, skippedDescriptor = "([Ljava/lang/Object;)Ljava/lang/Object;")
    public static final Object newInstance(Constructor<?> constructor, Object[] initargs, Ret ret)
            throws IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
        try {
            Class<?>[] instTypes = MethodInstrumentation.getInstrumentedTypes(constructor.getParameterTypes());
            Constructor<?> instConstructor = constructor.getDeclaringClass().getDeclaredConstructor(instTypes);
