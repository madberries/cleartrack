...
public final class StringInstrumentation {
  ...
  protected static final String removeOrReplaceNullChars(String description, String s, char oldChar,
      Ret ret) throws IOException {
    // MySQL stuff will break if we don't bipass this even for unknown regions since there are weird
    // conversions that create strings on byte arrays containing null bytes.
    ...
    if (newChar < 0) { // It must be log only.
      StringBuilder msg =
          new StringBuilder("Encountered a String containing null bytes at indicies = ");
      msg.append(index);
  ...
  public static final String valueOf(char c, int c_t, Ret ret) throws IOException {
    ...
    if (c == 0 && (c_t & TaintValues.TAINTED) == TaintValues.TAINTED) { // CWE-626 Null Byte
                                                                        // Interaction Error.
      int replaceChar = BaseConfig.getInstance().reportNullByte("String.valueOf(char)",
          "Attempting to convert null character to a String.");
      if (replaceChar == 0)
        s = "";
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint bytes, Charset charset, Ret ret)
      throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint ascii, int hibyte, int hibyte_t, Ret ret)
      throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint bytes, String charsetName, Ret ret)
      throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint bytes, int offset, int offset_t, int length,
      int length_t, Ret ret) throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(CharArrayTaint chars, int offset, int offset_t, int count,
      int count_t, Ret ret) throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(IntArrayTaint codePoints, int offset, int offset_t, int count,
      int count_t, Ret ret) throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint bytes, int offset, int offset_t, int length,
      int length_t, Charset charset, Ret ret) throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint ascii, int offset, int offset_t, int hibyte,
      int hibyte_t, int count, int count_t, Ret ret) throws IOException {
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR,
      instrumentationLocation = InstrumentationLocation.APP)
  public static final String init(ByteArrayTaint bytes, int offset, int offset_t, int length,
      int length_t, String charsetName, Ret ret) throws IOException {
  ...
  public static final int compareTo(String s1, String s2, Ret ret) {
    ...
    try {
      if (s1 == null) {
        if (s2 == null) {
          errorMsg =
              "Unchecked null pointer on string comparison: " + s1 + ".compareTo(" + s2 + ")";
          return 0;
        }
      ...
      if (errorMsg != null) {
        NotifyMsg notifyMsg =
            new NotifyMsg("String.compareTo(String)", "String.compareTo(" + s2 + ")", 252);
  ...
  @InstrumentationMethod
  public static final int indexOf(String s, int ch, int ch_t, int fromIndex, int fromIndex_t,
      Ret ret) {
  ...
  @InstrumentationMethod
  public static final int indexOf(String s, String searchStr, int fromIndex, int fromIndex_t,
      Ret ret) {
  ...
  @InstrumentationMethod
  public static final int lastIndexOf(String s, int ch, int ch_t, int fromIndex, int fromIndex_t,
      Ret ret) {
  ...
  @InstrumentationMethod
  public static final int lastIndexOf(String s, String searchStr, int fromIndex, int fromIndex_t,
      Ret ret) {
  ...
  @InstrumentationMethod(instrumentationLocation = InstrumentationLocation.APP)
  public static final String replace(String s, char oldChar, int oldChar_t, char newChar,
      int newChar_t, Ret ret) throws IOException {
    if (newChar == 0) {
      String newStr =
          removeOrReplaceNullChars("String.replace(String, char, char)", s, oldChar, ret);
      if (newStr != s)
        return newStr;
