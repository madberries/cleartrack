...
public final class ArrayInstrumentation {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final Object newInstance(Class<?> klass, int length, int length_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final boolean getBoolean(Object array, int index, int index_t, Ret ret) throws IOException {
        if (!(array instanceof BooleanArrayTaint))
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final byte getByte(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final short getShort(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final char getChar(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final long getLong(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final float getFloat(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final double getDouble(Object array, int index, int index_t, Ret ret) throws IOException {
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void set(Object array, int index, int index_t, Object value, Ret ret) throws IOException {
        if (array instanceof BooleanArrayTaint) {
            ((BooleanArrayTaint) array).store(index, index_t, ((CleartrackBoolean) value).booleanValue(ret), ret.taint);
            return;
        } else if (array instanceof ByteArrayTaint) {
            ((ByteArrayTaint) array).store(index, index_t, ((CleartrackByte) value).byteValue(ret), ret.taint);
            return;
        } else if (array instanceof ShortArrayTaint) {
            ((ShortArrayTaint) array).store(index, index_t, ((CleartrackShort) value).shortValue(ret), ret.taint);
            return;
        } else if (array instanceof CharArrayTaint) {
            ((CharArrayTaint) array).store(index, index_t, ((CleartrackCharacter) value).charValue(ret), ret.taint);
            return;
        } else if (array instanceof IntArrayTaint) {
            ((IntArrayTaint) array).store(index, index_t, ((CleartrackInteger) value).intValue(ret), ret.taint);
            return;
        } else if (array instanceof FloatArrayTaint) {
            ((FloatArrayTaint) array).store(index, index_t, ((CleartrackFloat) value).floatValue(ret), ret.taint);
            return;
        } else if (array instanceof LongArrayTaint) {
            ((LongArrayTaint) array).store(index, index_t, ((CleartrackLong) value).longValue(ret), ret.taint);
            return;
        } else if (array instanceof DoubleArrayTaint) {
            ((DoubleArrayTaint) array).store(index, index_t, ((CleartrackDouble) value).doubleValue(ret), ret.taint);
            return;
        }
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setBoolean(Object array, int index, int index_t, boolean value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof BooleanArrayTaint))
            throw new IllegalArgumentException("Argument is not a boolean[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setByte(Object array, int index, int index_t, byte value, int value_t, Ret ret)
            throws IOException {
        if ((array instanceof BooleanArrayTaint) || !(array instanceof ByteArrayTaint))
            throw new IllegalArgumentException("Argument is not a byte[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setShort(Object array, int index, int index_t, short value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof ShortArrayTaint))
            throw new IllegalArgumentException("Argument is not a short[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setChar(Object array, int index, int index_t, char value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof CharArrayTaint))
            throw new IllegalArgumentException("Argument is not a char[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setInt(Object array, int index, int index_t, int value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof IntArrayTaint))
            throw new IllegalArgumentException("Argument is not an int[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setLong(Object array, int index, int index_t, long value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof LongArrayTaint))
            throw new IllegalArgumentException("Argument is not a long[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setFloat(Object array, int index, int index_t, float value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof FloatArrayTaint))
            throw new IllegalArgumentException("Argument is not a float[]");
    ...
    @InstrumentationMethod(invocationType = InvocationType.STATIC)
    public static final void setDouble(Object array, int index, int index_t, double value, int value_t, Ret ret)
            throws IOException {
        if (!(array instanceof DoubleArrayTaint))
            throw new IllegalArgumentException("Argument is not a double[]");
