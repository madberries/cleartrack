...
public class ReadableByteChannelInstrumentation {
    ...
    // This is only here because bytes can be read from a FileInputStream in
    // an unconventional way, by acquiring the channel from the stream.  See
    // java.util.Scanner, for example.

    @InstrumentationMethod
    public static final int read(ReadableByteChannel rbc, ByteBuffer dst, Ret ret) throws IOException {
