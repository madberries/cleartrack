...
public final class ObjectInstrumentation {
    ...
    @InstrumentationMethod(instrumentationType = InstrumentationType.INSERT_AFTER, instrumentationLocation = InstrumentationLocation.TRANS, name = "getClass", descriptor = "()Ljava/lang/Class;")
    ...
    @InstrumentationMethod(canExtend = true, skippedDescriptor = "()Ljava/lang/String;", name = "toString", descriptor = "(Lpac/util/Ret;)Ljava/lang/String;")
    ...
    public static final void wait(Object obj) throws InterruptedException {
        // monitors have been replaced by ReentrantLocks, so call our
