...
public final class ZipEntryInstrumentation {
  ...
  /*
   * TODO: We need to revisit this... I'm not sure if we really want to trust all paths inside of a
   * zip/jar file. but this is necessary for jmeter to work properly.
   */
