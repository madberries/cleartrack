...
public final class RandomAccessFileInstrumentation {
  ...
  public static final RandomAccessFile init(File file, String mode, Ret ret)
    ...
    try {
      // cwe-0 signals not to output msg to test harness.
      final NotifyMsg notifyMsg = new NotifyMsg("RandomAccessFile(File, String)",
          "RandomAccessFile(" + file.toString() + ", " + mode + ")", 0);
  ...
  @InstrumentationMethod(invocationType = InvocationType.CONSTRUCTOR)
  public static final RandomAccessFile init(String name, String mode, Ret ret)
      throws FileNotFoundException {
    ...
    try {
      final NotifyMsg notifyMsg = new NotifyMsg("RandomAccessFile(String, String)",
          "RandomAccessFile(" + name + "," + mode + ")", 0); // CWE-0 signals not to output msg to
                                                             // test harness.
  ...
  @InstrumentationMethod
  public static final int read(RandomAccessFile raf, ByteArrayTaint b, int off, int off_t, int len,
