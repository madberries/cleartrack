...
public final class BufferedReaderInstrumentation {
  ...
  public static final String readLine(BufferedReader br, Ret ret) throws IOException {
    ...
    if (br.ss_socktype == SocketType.SERVER_SOURCE)
      str =
          BaseConfig.getInstance().runServerSocketInputCheck("BufferedReader.readLine()", str, ret);
    return StringInstrumentation.removeOrReplaceNullChars("BufferedReader.readLine()", str,
        (char) 0, ret);
  }

  @InstrumentationMethod(canExtend = true)
  public static final int read(BufferedReader br, CharArrayTaint cbuf, int off, int off_t, int len,
