...
public final class ByteArrayTaint implements Serializable, TaintableArray {
  ...
  public static final ByteArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t)
      throws IOException {
  ...
  public static final ByteArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2,
  ...
  public static final boolean isTainted(ByteArrayTaint b, int start, int start_t, int end,
      int end_t, Ret ret) {
    ret.taint = TaintValues.TRUSTED;
    int[] taint = b.taint;
    for (int i = start; i <= end; i++) {
  ...
  public static final boolean isTrusted(ByteArrayTaint b, int start, int start_t, int end,
      int end_t, Ret ret) {
    ret.taint = TaintValues.TRUSTED;
    int[] taint = b.taint;
    if (taint == null)
  ...
  public static final void taint(ByteArrayTaint b, int start, int start_t, int end, int end_t,
      Ret ret) {
    for (int i = start; i <= end; i++) {
  ...
  public static final void trust(ByteArrayTaint b, int start, int start_t, int end, int end_t,
      Ret ret) {
    for (int i = start; i <= end; i++) {
  ...
  public static final boolean hasEqualTaint(ByteArrayTaint arr1, ByteArrayTaint arr2, int length,
      int length_t, Ret ret) {
    return hasEqualTaint(arr1, arr2, 0xffffffff, TaintValues.TRUSTED, length, length_t, ret);
  }

  public static final boolean hasEqualTaint(ByteArrayTaint arr1, ByteArrayTaint arr2, int mask,
      int mask_t, int length, int length_t, Ret ret) {
    ret.taint = TaintValues.TRUSTED;
  ...
  public static final boolean isAllTainted(ByteArrayTaint b, int start, int start_t, int end,
      int end_t, Ret ret) {
    ret.taint = TaintValues.TRUSTED;
    int[] taint = b.taint;
    for (int i = start; i <= end; i++) {
