...
public final class FloatArrayTaint implements Serializable, TaintableArray {
  ...
  public static final FloatArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t)
      throws IOException {
  ...
  public static final FloatArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2,
