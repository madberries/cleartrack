...
public final class CharArrayTaint implements Serializable, TaintableArray {
    ...
    public static final CharArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t) throws IOException {
    ...
    public static final CharArrayTaint[][] newArray(int len1, int len1_t, int len2, int len2_t, int len3, int len3_t)
            throws IOException {
    ...
    public static final CharArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2, int len2_t, int len3,
                                                            int len3_t)
            throws IOException {
        char[][][] value = new char[len1][len2][len3];
        CharArrayTaint[][] taint = new CharArrayTaint[len1][len2];
    ...
    public static final boolean isTainted(CharArrayTaint b, int start, int start_t, int end, int end_t, Ret ret) {
        ret.taint = TaintValues.TRUSTED;
        return isTainted(b, start, end);
    }

    public static final boolean isAllTainted(CharArrayTaint b, int start, int start_t, int end, int end_t, Ret ret) {
        ret.taint = TaintValues.TRUSTED;
    ...
    public static final boolean isTrusted(CharArrayTaint b, int start, int start_t, int end, int end_t, Ret ret) {
        ret.taint = TaintValues.TRUSTED;
    ...
    public static final void taint(CharArrayTaint b, int start, int start_t, int end, int end_t, Ret ret) {
        for (int i = start; i <= end; i++) {
    ...
    public static final void trust(CharArrayTaint b, int start, int start_t, int end, int end_t, Ret ret) {
        for (int i = start; i <= end; i++) {
    ...
    public static final boolean hasEqualTaint(CharArrayTaint arr1, CharArrayTaint arr2, int mask, int mask_t, Ret ret) {
        ret.taint = TaintValues.TRUSTED;
