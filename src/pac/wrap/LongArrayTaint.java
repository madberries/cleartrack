...
public final class LongArrayTaint implements Serializable, TaintableArray {
  ...
  public final long load(int idx, int idx_t, Ret ret) throws IOException {
    ...
    if (idxTaint != TaintValues.TRUSTED && (idx < 0 || idx >= taint.length)) { // Index out of
      ...
      return 0L; // Return the default value.
    }
  ...
  public static final LongArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t)
      throws IOException {
  ...
  public static final LongArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2,
