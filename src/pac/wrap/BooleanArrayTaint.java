...
public final class BooleanArrayTaint implements Serializable, TaintableArray {
    ...
    public static final BooleanArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t) throws IOException {
    ...
    public static final BooleanArrayTaint[] newArray_noCheck(int len1, int len1_t, int len2, int len2_t)
            throws IOException {
        boolean[][] value = new boolean[len1][len2];
        BooleanArrayTaint[] taint = new BooleanArrayTaint[len1];
        for (int i = 0; i < value.length; i++) {
    ...
    public static final BooleanArrayTaint[][] newArray(int len1, int len1_t, int len2, int len2_t, int len3, int len3_t)
            throws IOException {
    ...
    public static final BooleanArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2, int len2_t, int len3,
                                                               int len3_t)
            throws IOException {
        boolean[][][] value = new boolean[len1][len2][len3];
        BooleanArrayTaint[][] taint = new BooleanArrayTaint[len1][len2];
