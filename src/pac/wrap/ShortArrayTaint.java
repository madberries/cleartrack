...
public final class ShortArrayTaint implements Serializable, TaintableArray {
  ...
  public static final ShortArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t)
      throws IOException {
  ...
  public static final ShortArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2,
