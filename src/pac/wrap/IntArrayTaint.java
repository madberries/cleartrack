...
public final class IntArrayTaint implements Serializable, TaintableArray {
  ...
  public static final IntArrayTaint newArray(int len, int len_t) throws IOException {
    if ((len_t & TaintValues.TRUST_MASK) != TaintValues.TRUSTED) {
      // Wow, this apparently gets called so early that String cannot even be loaded yet.
  ...
  public static final IntArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t)
      throws IOException {
  ...
  public static final boolean isTainted(IntArrayTaint b, int start, int start_t, int end, int end_t,
      Ret ret) {
    ret.taint = TaintValues.TRUSTED;
    int[] taint = b.taint;
  ...
  public static final void taint(IntArrayTaint b, int start, int start_t, int end, int end_t,
      Ret ret) {
    for (int i = start; i <= end; i++) {
