...
public final class DoubleArrayTaint implements Serializable, TaintableArray {
    ...
    public static final DoubleArrayTaint[] newArray(int len1, int len1_t, int len2, int len2_t) throws IOException {
    ...
    public static final DoubleArrayTaint[] newArray_noCheck(int len1, int len1_t, int len2, int len2_t)
            throws IOException {
        double[][] value = new double[len1][len2];
        DoubleArrayTaint[] taint = new DoubleArrayTaint[len1];
        for (int i = 0; i < value.length; i++) {
    ...
    public static final DoubleArrayTaint[][] newArray(int len1, int len1_t, int len2, int len2_t, int len3, int len3_t)
            throws IOException {
    ...
    public static final DoubleArrayTaint[][] newArray_noCheck(int len1, int len1_t, int len2, int len2_t, int len3,
                                                              int len3_t)
            throws IOException {
        double[][][] value = new double[len1][len2][len3];
        DoubleArrayTaint[][] taint = new DoubleArrayTaint[len1][len2];
