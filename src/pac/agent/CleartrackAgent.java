...
public class CleartrackAgent {
    ...
    private static class DynamicInstrumentationTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
            ...
            // Dynamic classes will not be loaded on the bootstrap class
            // path, so do not worry about this case...
            if (loader == null)
                return classfileBuffer;

            // Not sure if we really want to instrument these JVM created
            // classes...
            if (className.contains("$Proxy") || className.startsWith("sun/") || className.startsWith("com/sun/"))
                return classfileBuffer;
