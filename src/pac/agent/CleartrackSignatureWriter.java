...
/**
 * Instruments java generic signatures by replacing primitive types with their taint wrapped type.
 * Or by adding taint arguments after the type, in the case of primitive types.
 * 
 * @author jeikenberry
 */
public class CleartrackSignatureWriter extends SignatureVisitor {
  ...
  public void visitBaseType(char descriptor) {
    String instType =
        arrDim > 0 ? AsmUtils.toWrappedArrayType("" + descriptor).getInternalName() : null;
    if (arrDim == 0) {
