...
/**
 * Replaces CheckClassAdapter to utilize the CleartrackVerifier (instead of the
 * standard SimpleVerifier).  This will enable accurate verification by making
 * queries to the ClassHierarchy.
 * 
 * @author jeikenberry
 */
public class CleartrackCheckClassAdapter extends CheckClassAdapter {
    ...
    public static void verify(final ClassReader cr, final ClassLoader loader, final boolean dump,
        ...
        for (int i = 0; i < methods.size(); ++i) {
            ...
            CleartrackVerifier verifier = new CleartrackVerifier(Type.getObjectType(cn.name), syperType, interfaces,
