...
/**
 * CellEditor for editing the instructions opcode.  Selection is done via a
 * combo box.  Any change will result in removing the current instruction 
 * and added a new type of the selected opcode.
 * 
 * @author jeikenberry
 */
public class OpcodeCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public OpcodeCellEditor() {
        ...
        // Install "content-assist-like" support for the opcode combo-box
        // to make selecting items faster.
        try {
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        if (value instanceof AbstractInsnNode) {
            ...
            // if the value is not of type AbstractInsnNode, i.e. null,
            // then just select the NOP instruction by default.
    ...
    /**
     * Opcodes copied from org.objectweb.asm.Opcodes, but converted into
     * an enum type.
     * 
     * @author jeikenberry
     */
