...
/**
 * Represents the view for manipulating the scoped types behind the
 * current MethodNode (i.e exceptions, locals, etc...).
 * 
 * @author jeikenberry
 */
public class Scoping extends JPanel {
    ...
    public void setMethod(MethodNode methodNode) {
        ...
        ((ExceptionHandlerTableModel) exceptionsTable.getModel()).setExceptionHandlers(methodNode.tryCatchBlocks);
    }
