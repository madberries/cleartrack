...
public class OffsetCellRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        // If there was a verify error on this row, then set the
        // tooltip text to be the error message.
    ...
    /**
     * Construct the indicator shape for a verify error in the given
     * graphics context.
     * 
     * @param g2 Graphics2D
     * @return Shape
    ...
    private Shape getErrorShape(Graphics2D g2) {
        ...
        Shape outline = textTl
                .getOutline(AffineTransform.getTranslateInstance((bounds.getWidth() - fm.stringWidth("!")) / 2.0d,
    ...
    public void paintComponent(Graphics g) {
        ...
        if (hasError) {
            ...
            // We need to scale down the shape to fit within the bounds
            // of this label component (and after the label itself)...
            // Order of affine transformation matters, of course.
            g2.transform(AffineTransform
                    .getTranslateInstance(inset + g2.getFontMetrics(getFont()).stringWidth(getText()), inset));
