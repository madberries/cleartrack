...
/**
 * This cell render operates on AbstractInsnNode's (with non-negative opcodes). LabeNode's are
 * color-coded, and assigned names in a lexicologically first fashion.
 * 
 * @author jeikenberry
 */
public class InstructionCellRenderer extends DefaultTableCellRenderer {
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
    ...
    if (insnNode == null) {
      ...
      setFont(getFont()
          .deriveFont(insnNode instanceof LdcInsnNode && column > 2 ? Font.ITALIC : Font.BOLD));
   ...
   * @return String
   */
  private static String getSwitchString(List<Integer> keys, List<LabelNode> labels,
   ...
   * @param standalone indicates that this LabelNode is by itself and not part of a jump or switch.
   * @return String
   */
