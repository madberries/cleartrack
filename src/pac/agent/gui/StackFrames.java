...
/**
 * Component for viewing initialized local variable/register types, and
 * also for viewing the stack of the current selected instruction.
 * 
 * @author jeikenberry
 */
public class StackFrames extends JComponent {
     ...
     * @param maxWidth int of the maximum width String to
     *   return (in pixels).
     * @return String of the ASM type name for local (truncated to
     *   fit within the bounds of maxWidth).
     */
    ...
    public Dimension getPreferredSize() {
        ...
        if (methodNode != null) {
            ...
            prefHeight = ((methodNode.maxLocals / NUM_OF_LOCAL_COLS) + rem + methodNode.maxStack + 1) * 20 + INSET * 7;
