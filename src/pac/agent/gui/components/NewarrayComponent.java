 ...
 * @author jeikenberry
 */
public class NewarrayComponent extends JComboBox<String> implements ActionListener, InstructionComponent {
    ...
    public NewarrayComponent() {
        super(new String[] { "T_BOOLEAN", "T_CHAR", "T_FLOAT", "T_DOUBLE", "T_BYTE", "T_SHORT", "T_INT", "T_LONG" });
    }
