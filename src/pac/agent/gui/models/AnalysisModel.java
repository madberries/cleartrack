...
/**
 * This model represents a method (or constructor) node and it's children,
 * for use with the Analysis tree viewer.
 * 
 * @author jeikenberry
 */
public class AnalysisModel implements TreeModel {
    ...
    /**
     * Set the root node to operate on.  The node must be an Element,
     * whose name is one of: "class-constructor", "constructor", or
     * "method".
     * 
     * @param root Node
     */
    public void setRoot(Node root) {
        ...
        this.root = root;
        // determine the correct path to issue the tree structure
        // change...
        if (oldRoot == null) {
            if (root == null)
                return;
    ...
    public void valueForPathChanged(TreePath path, Object newValue) {
        // This tree is not editable (other than swapping out the
        // root node itself).
    }
