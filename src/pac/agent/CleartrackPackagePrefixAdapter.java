...
/**
 * Use this class to generate a new class with the "pac" added to the package prefix of each class.
 * This is needed to ensure that application libraries don't conflict with instrumentation
 * libraries.
 * 
 * @author jeikenberry
 */
