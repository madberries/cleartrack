...
public class CharSequenceInstrumentationTest {
    ...
    public void subSequenceTest() {
        ...
        Assert.assertFalse("untainted region marked as tainted", TaintUtils.isTainted(cs2.toString(), 0, 1));
        Assert.assertTrue("tainted region not marked as tainted", TaintUtils.isTainted(cs2.toString(), 2, 5));
        Assert.assertFalse("untainted region marked as tainted", TaintUtils.isTainted(cs2.toString(), 6, 7));
    }
