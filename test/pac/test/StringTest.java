...
public class StringTest {
    ...
    /**
     * Perform sanity check to ensure that taint is as we expect it
     * and throw an assertion if we find any discrepancies.
     */
        ...
        public void run() {
            for (int i = 1; i <= MAX_ITERS; i++) {
                try {
                    ...
                    // We can get a StringIndexOutOfBoundsException since we do not synchronize
                    // when we acquire the length of the StringBuffer...
                }
            }
        }
    }
