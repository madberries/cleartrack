...
public class HibernateTest //extends StatementInjectionTest
{
    ...
    private void testHibernateInjections(List<List<String>> rows) {
        ...
        for (List<String> adata : rows) {
            ...
            if (func.equalsIgnoreCase("verifyPassword")) {
                ...
                //				try
                //				{
                //					resultString = new VerifyPasswordNoQuotesHibernate()
                //							.verifyPasswords(name, pass);
                //				}
                //				catch (SQLException e)
                //				{
                //					// TODO Auto-generated catch block
    ...
    public String verifyPasswordHql(String name, String password) throws SQLException {
        ...
        List<Employee> elist = query("from Employee where name = '" + name + "' and password='" + password + "'");
        String retValue = "";
    ...
    private List<Employee> query(String query) {
        ...
        try {
            ...
            System.out.println("Exception: " + e.getMessage());
            // System.out.println("qe class: " +
            // e.getClass().getCanonicalName());
        } catch (GenericJDBCException e) // A problem occurred translating a
                                         // Hibernate query to SQL due to invalid
                                         // query syntax, etc.
        {
            System.out.println("Exception: " + e.getMessage());
            // System.out.println("class " + e.getClass().getCanonicalName());
            // System.out.println("Exception caught when executing hql: " +
            // query);
            // System.out.println(e.getMessage());
            // System.out.println();
        } catch (CleartrackException sse) {
            // If diversity is enabled, we may see this...
            throw sse;
    ...
    static public SessionFactory getH2Session() {
        ...
        // need to figure out a way to turn off hibernate logging completely.
