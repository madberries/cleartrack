...
public class SanitizedStatementInjectionTest //extends StatementInjectionTest 
{
    ...
    public String sanitizeUsingString1(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (c == '\'') {
                result = result + '\'';
                //				Assert.assertTrue("Incoming character constant should match the taint value of the previous read character.", 
    ...
    public void sanitizedInputTest1() {
        ...
        final String TEST_PASSWORD = sanitizeUsingStringBuffer1(sit.getQueryFromFile("injectUsingOr", "password"));
    ...
    public void sanitizedInputTest2() {
        final String TEST_NAME = "Brian";
        final String TEST_PASSWORD = sanitizeUsingStringBuffer2(sit.getQueryFromFile("injectUsingOr", "password"));
        TaintUtils.taint(TEST_NAME);
        String resultString = null;
        try {
            resultString = sit.verifyPassword(TEST_NAME, TEST_PASSWORD);
    ...
    public void sanitizedInputTest3() {
        final String TEST_NAME = "Brian";
        final String TEST_PASSWORD = sanitizeUsingString1(sit.getQueryFromFile("injectUsingOr", "password"));
        TaintUtils.taint(TEST_NAME);
        String resultString = null;
        try {
            resultString = sit.verifyPassword(TEST_NAME, TEST_PASSWORD);
    ...
    public void sanitizedInputTest4() {
        final String TEST_NAME = "Brian";
        final String TEST_PASSWORD = sanitizeUsingString2(sit.getQueryFromFile("injectUsingOr", "password"));
        TaintUtils.taint(TEST_NAME);
        String resultString = null;
        try {
            resultString = sit.verifyPassword(TEST_NAME, TEST_PASSWORD);
