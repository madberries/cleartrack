...
public class SystemInstrumentationTest {
  ...
  public void mapTest() {
    ...
    if (map != null) {
      for (Entry<String, String> entry : map.entrySet()) {
        ...
        Assert.assertFalse(
            "System.getenv has key " + key + " whose value " + value + " has unknown trust",
  ...
  public void getPropertyTest() {
    ...
    Assert.assertTrue("System.getProperty(untrusted String) returned a property value",
        "".equals(val));
    ...
    // ***
    // Test System.getProperty(key, def) with untrusted key and untrusted def - "" should be
    // returned.
    ...
    val = System.getProperty(key);
    Assert.assertFalse("System.getProperty(trusted String) did not return the property value",
        "".equals(val));
    ...
    val = System.getProperty(key, def);
    Assert.assertFalse(
        "System.getProperty(trusted String, String def) did not return the property value",
        "".equals(val));
