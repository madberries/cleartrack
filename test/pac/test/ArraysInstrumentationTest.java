...
public class ArraysInstrumentationTest {
    ...
    public void sortTest() {
        // populate an array of random tainted integers
        // where the taint matches the value...
        ...
        // ensure not only that the array is sorted, but 
        // that the taint at each index matches the value
        // at the same index...
    ...
    public void overflowUnderflowTest() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            Assert.assertEquals("Overflowed index should equals \"OVERFLOW\" when converted to a string.", overStr,
                                "OVERFLOW");
    ...
    public void divideByZeroTest() {
        ...
        Assert.assertTrue("CleartrackException should have been caught on infinite array index", exCaught);
    ...
    public void boolNewArrayTest() {
        ...
        Assert.assertTrue("CleartrackException should have been caught on infinite newarray dimension", exCaught);
