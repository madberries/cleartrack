...
public class URLInstrumentationTest {
    ...
    /**
     * Creates a random string with random taint that can
     * be encoded.
     * 
    ...
    /**
     * Creates a random encoded string such that encoded characters
     * contain mixed taint.
     * 
     * @param len length of the string to create
     * @return String
    ...
    private static String[] createRandomMalformedString(int len) throws IOException {
        ...
        for (int i = 0; i < len; i++) {
            if (rand.nextFloat() >= 0.33f) { // non-encoded character...
                ...
                // determine random taint for each character in the encoding
                // such that at least one of them differs...
                ...
                // append random encoded character...
    ...
    public void URLTest() {
        try {
            ...
            String spec = TaintUtils.trust("http://www.soc.uts.edu.au:80/MosaicDocs%20ol/url-primer.html");
            ...
            Assert.assertFalse("URL(String) path component was untrusted and contains attack chars. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String) path component was untrusted and contains attack chars. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(String) path component was untrusted and begins with slash. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String) path component was untrusted and begins with slash. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(String,String,int,String) file begins with slash. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String,String,int,String) file begins with slash. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(String,String,int,String) file is trusted. Should not have thrown exception",
                               caughtEx);
            if (url != null) {
                path = url.getPath();
                Assert.assertTrue("URL(String,String,int,String)  URL.getPath() failed to return the correct path of file",
                                  "/my/attack.html".equals(file));
                Assert.assertTrue("URL(String,String,int,String)  file is trusted. URL.getPath() failed to return the trusted path",
            ...
            // **** Test URL(String,String,int,String,URLStreamHandler)
            // ****
            // ***
            URLStreamHandler handler = null;

            // Test URL(String,String,int,String,URLStreamHandler) with tainted file that begins with attack slash
            file = "/my/attack.html";
            TaintUtils.taint(file);
            caughtEx = false;
            try {
            ...
            Assert.assertFalse("URL(String,String,int,String,URLStreamHandler) file is untrusted and begins with slash. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String,String,int,String,URLStreamHandler) file is untrusted and begins with slash. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(String,String,int,String,URLStreamHandler) file is trusted. Should not have thrown exception",
                               caughtEx);
            if (url != null) {
                path = url.getPath();
                Assert.assertTrue("URL(String,String,int,String)  URL.getPath() failed to return the correct path of file",
            ...
            // Test URL(String,String,int,String,URLStreamHandler) with tainted file that contains attack dot dot
            file = "my/../attack.html";
            TaintUtils.taint(file);
            caughtEx = false;
            try {
            ...
            Assert.assertFalse("URL(String,String,String) file is untrusted and begins with slash. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String,String,String) file is untrusted and begins with slash. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(String,String,String) file is untrusted and contains an encoding. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(String,String,String) file is untrusted and contains an encoding. Should have thrown exception",
                              caughtEx);
            ...
            Assert.assertFalse("URL(URL,String) file is untrusted and begins with slash. Should have thrown exception",
                               caughtEx);
            ...
            Assert.assertTrue("URL(URL,String) file is untrusted and begins with slash. Should have thrown exception",
                              caughtEx);
