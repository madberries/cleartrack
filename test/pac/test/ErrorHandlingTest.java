    ...
    public void parseIntTest() {
        ...
        for (int j = 0; j < ITERS; j++) {
            ...
            try {
                ...
                Assert.fail("We should not see a number format exception on a malformed tainted string: " + english);
            }
            ...
            try {
                ...
                Assert.fail("We should not see a number format exception on a well-formed tainted string: " + number);
            }
            ...
            Assert.assertNotNull("We should see a number format exception on a malformed trusted string: " + english,
                                 throwEx);
