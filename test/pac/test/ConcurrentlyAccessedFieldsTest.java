...
public class ConcurrentlyAccessedFieldsTest {
  ...
  public void emptyTest() {
    // Need at least one JUnit test here, or JUnit is not happy.
  }
  ...
  public void noSynchronizationIncTest() {
    ...
    join(t1);
    join(t2);
    Assert.assertTrue("failed to synchronize updating static field; count1 = " + count1
        + " (expected: " + EXPECTED_RESULT + ")", count1 == EXPECTED_RESULT);
  }
  ...
  public void noSynchronizationIncDecTest() {
    ...
    join(t2);
    Assert.assertTrue(
        "failed to synchronize updating static field; count1 = " + count1 + " (expected: 0)",
        count2 == 0);
  }
  ...
  public void methodSynchronizationIncTest() {
    ...
    join(t1);
    join(t2);
    Assert.assertTrue("failed to synchronize updating static field: count2 = " + count2
        + " (expected: " + EXPECTED_RESULT + ")", count2 == EXPECTED_RESULT);
  }
  ...
  public void methodSynchronizationIncDecTest() {
    ...
    join(t2);
    Assert.assertTrue(
        "failed to synchronize updating static field: count2 = " + count2 + " (expected: 0)",
        count2 == 0);
  }
  ...
  public void objectSynchronizationIncTest() {
    ...
    join(t1);
    join(t2);
    Assert.assertTrue("failed to synchronize updating static field: count3 = " + count3
        + " (expected: " + EXPECTED_RESULT + ")", count3 == EXPECTED_RESULT);
  }
  ...
  public void fieldIncTest() {
    ...
    Assert.assertTrue("failed to synchronized updating object field: result = " + result
        + " (expected: " + EXPECTED_RESULT + ")", result == EXPECTED_RESULT);
  }
