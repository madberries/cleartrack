...
public class CharsetAllInstrumentationTest {
  ...
  public void charsetTest() {
    ...
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb.array(), 0, 5));
    Assert.assertTrue("tainted region not marked tainted",
        ByteArrayTaint.isTainted(bb.array(), 6, 8));
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb.array(), 9, 9));
    ...
    // Ensure that the entire byte buffer is tainted.
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb2.array(), 0, 1));
    Assert.assertTrue("tainted region not marked tainted",
        ByteArrayTaint.isTainted(bb2.array(), 2, 5));
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb2.array(), 6, 9));
    ...
    Assert.assertTrue("tainted region not marked tainted",
        CharArrayTaint.isTainted(cb2.array(), 4, 8));
    Assert.assertFalse("trusted region not marked trusted",
        CharArrayTaint.isTainted(cb2.array(), 9, 9));
  }
  ...
  public void charsetEncoderTest() {
    ...
    // Ensure that the entire output is tainted.
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb2.array(), 0, 5));
    Assert.assertTrue("tainted region not marked tainted",
        ByteArrayTaint.isTainted(bb2.array(), 6, 8));
    Assert.assertFalse("trusted region not marked trusted",
        ByteArrayTaint.isTainted(bb2.array(), 9, 9));
  }
  ...
  public void charsetDecoderTest() {
    ...
    // Ensure that the entire output is tainted.
    Assert.assertFalse("trusted region not marked trusted",
        CharArrayTaint.isTainted(cb.array(), 0, 5));
    Assert.assertTrue("tainted region not marked tainted",
        CharArrayTaint.isTainted(cb.array(), 6, 8));
    Assert.assertFalse("trusted region not marked trusted",
        CharArrayTaint.isTainted(cb.array(), 9, 9));
    ...
    // Ensure that the entire output is tainted.
    Assert.assertFalse("trusted region not marked trusted",
        CharArrayTaint.isTainted(cb2.array(), 0, 5));
    Assert.assertTrue("tainted region not marked tainted",
        CharArrayTaint.isTainted(cb2.array(), 6, 8));
    Assert.assertFalse("trusted region not marked trusted",
        CharArrayTaint.isTainted(cb2.array(), 9, 9));
  }
