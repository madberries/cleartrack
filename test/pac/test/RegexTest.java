 ...
 * operations. It is not a test of the instrumentation of a specific class as we may need to use
 * various techniques in order to track trust through regex operations.
 * 
 * @author ppiselli
 */
public class RegexTest {
  ...
  public void testPatternSplit() {
    ...
    // Make sure the taint propogated.
  ...
  public void testMatcherAppend() {
    ...
    // By taint spreading rules, taint should have spread to "llama two llamas" and the region "the"
    // should still be tainted.
