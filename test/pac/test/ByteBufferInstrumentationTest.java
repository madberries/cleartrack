...
public class ByteBufferInstrumentationTest {
  ...
  public void arrayTest() {
    ...
    Assert.assertFalse("non-tainted region not marked as tainted",
        ByteArrayTaint.isTainted(ba, 0, 2));
    Assert.assertTrue("tainted region not marked as tainted", ByteArrayTaint.isTainted(ba, 3, 7));
    Assert.assertFalse("non-tainted region not marked as tainted",
        ByteArrayTaint.isTainted(ba, 8, 9));
  }
  ...
  public void duplicateTest() {
    ...
    Assert.assertTrue("tainted region not marked as tainted",
        ByteArrayTaint.isTainted(bb2.array(), 3, 7));
  }
  ...
  public void putTest() {
    ...
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb.array(), 0, 1));
    Assert.assertTrue("tainted region not marked as tainted",
        ByteArrayTaint.isTainted(bb.array(), 2, 3));
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb.array(), 4, 9));
    ...
    Assert.assertTrue("tainted region not marked as tainted",
        ByteArrayTaint.isTainted(bb.array(), 2, 3));
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb.array(), 4, 5));
    Assert.assertTrue("tainted region not marked as tainted",
    ...
    Assert.assertTrue("tainted region not marked as tainted",
        ByteArrayTaint.isTainted(bb2.array(), 2, 3));
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb2.array(), 4, 5));
    Assert.assertTrue("tainted region not marked as tainted",
  ...
  public void wrapTest() {
    ...
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb1.array(), 0, 2));
    Assert.assertTrue("tainted region not marked as tainted",
        ByteArrayTaint.isTainted(bb1.array(), 3, 7));
    Assert.assertFalse("untainted region marked as tainted",
        ByteArrayTaint.isTainted(bb1.array(), 8, 9));
