...
public class FileReaderInstrumentationTest {
  ...
  public void fileReaderTest() {
    ...
    // ***
    // FileReader(String) constructor. String param is trusted. Its path is refers to trusted
    // location.
    ...
    try {
      ...
      Assert.assertTrue("bytes read from file reader should be trusted",
          TaintUtils.isTrusted(fileReader.read()));
    ...
    // ***
    // FileReader(String) constructor. String param is not trusted. Its path is refers to trusted
    // location.
    // Test that returned FileReader is not tainted.
    path = TaintUtils.trust("/usr/bin/file");
    try {
    ...
    // ***
    // FileReader(String) constructor. String param is trusted. Its path is refers to untrusted
    // location.
