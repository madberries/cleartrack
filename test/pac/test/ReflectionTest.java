...
public class ReflectionTest {
    ...
    class TestInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object arg0, Method arg1, Object[] arg2, Ret ret) throws Throwable {
            // This is never actually called.  It's only here so that
            // eclipse does not mark this as having a compiler error.
            return null;
        }
        //#endif
    }
    ...
    public void proxyClassTest() {
        ProxyTest t = (ProxyTest) Proxy.newProxyInstance(ProxyTest.class.getClassLoader(),
                                                         ...
                                                         new TestInvocationHandler(new ProxyTestImpl()));
    ...
    public void reflectStringBuilder() {
        try {
            ...
            StringBuilder.class.getMethod("append", char[].class, int.class, int.class).invoke(sb, ca2, 5, 10);
    ...
    public void testFieldReflect()
        ...
        for (int i = 0; i < ITERS; i++) {
            ...
            field.set(null, f);
            val = field.get(null);
            Assert.assertEquals("varFloat should have been set to " + f, ((Float) val).floatValue(), f, 0);
        ...
        for (int i = 0; i < ITERS; i++) {
            ...
            field.set(null, d);
            val = field.get(null);
            Assert.assertEquals("varDouble should have been set to " + d, ((Double) val).doubleValue(), d, 0);
    ...
    @Test
    public void testArrayFieldReflect()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    ...
    @Test
    public void reflectMethodPrimitiveTest() throws NoSuchMethodException, SecurityException, IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
        // Make sure that primitive return types return from reflected
        // methods are compatible with their wrapped type...
        ...
        System.out.printf("primitive reflection results: %s %d %d %c %d %d %f %f\n", boolResult, byteResult,
                          shortResult, charResult, intResult, longResult, floatResult, doubleResult);
    }
    ...
    public void reflectMethodPrimitiveArrayTest() throws NoSuchMethodException, SecurityException,
        ...
        System.out.printf("primitive array reflection results: {%s} {%d} {%d} {%c} {%d} {%d} {%f} {%f}\n",
