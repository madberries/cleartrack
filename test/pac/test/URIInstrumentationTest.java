...
public class URIInstrumentationTest {
  ...
  public void URITest() {
    try {
      ...
      Assert.assertTrue(
          "URI(String) taint path component starting with slash. Did not throw excpetion",
          caughtEx);
      ...
      Assert.assertTrue(
          "URI(String) tainted path component starting with slash did not throw excpetion",
          caughtEx);
      ...
      Assert.assertFalse(
          "URI(String,String,int,String) file in ssp is trusted. Should not have thrown exception",
          caughtEx);
      ...
      Assert.assertTrue(
          "URI(String,String,int,String) file in ssp is tainted. Begins with slash. Should have thrown exception",
          caughtEx);
      ...
      Assert.assertTrue(
          "URI(String,String,int,String) file in ssp is tainted. Contains illegal chars. Should have thrown exception",
          caughtEx);
      ...
      Assert.assertFalse(
          "URI(String,String,String,int,String,Sring,String) file is trusted. Should not have thrown exception",
          caughtEx);
      ...
      Assert.assertFalse(
          "URI(String,String,String,Sring) file is trusted. Should not have thrown exception",
          caughtEx);
      ...
      Assert.assertTrue(
          "URI(String,String,String,Sring) file is tainted. Should have thrown exception",
          caughtEx);
      ...
      Assert.assertFalse(
          "URI(String,String,String,String,String) path is trusted. Should have thrown exception",
          caughtEx);
      ...
      Assert.assertTrue(
          "URI(String,String,String,String,String) path is tainted. Should have thrown exception",
          caughtEx);
      ...
      Assert.assertFalse(
          "URI(String,String,String,String,String) path is tainted but not illegal. Should not have thrown exception",
          caughtEx);
