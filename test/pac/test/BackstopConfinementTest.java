...
public class BackstopConfinementTest {
    ...
    public void testSocket_XQuery() {
        ...
        pw.println(xlogin);
        /*
        String xlogin_fixed = "//users/user[login/text()='" + login + 
        "' and password/text() = \"" + pass + "\"]/home_dir/text()";
         */
        String pass_fixed = pass.replaceAll("'", "''");
        String xlogin_fixed = "//users/user[login/text()='" + login + "' and password/text() = '" + pass_fixed
                + "']/home_dir/text()";
    ...
    public void testSocket_SQL() {
        ...
        String query = "SELECT id FROM employees where name = '" + name + "' AND password = '" + password + "';";
        pw.println(query);
    ...
    public void testSocket_LDAP() {
        ...
        Assert.assertTrue("Checking of tainted LDAP expression failed to replace the special characters",
    ...
    public void testSocket_Unknown() {
        ...
        Assert.assertTrue("Checking of tainted non numeric/alphanumeric string failed to throw RuntimeException",
                          caughtEx);
    }
