...
public class DryRunTestCase {
    ...
    static class ISBNChecker {
        ...
        public static boolean isValidISBN(String isbn) {
            ...
            int u = 1;
            for (int j = (u + 50) * 2 / 100 - 1; j < temp.length; j++) { //CLEARTRACK:loop_complexity_initialization
            ...
            if (isbn.length() == 13) {
                ...
                if (isbnInts[12] == (10 - ((isbnInts[0] + 3 * isbnInts[1] + isbnInts[2] + 3 * isbnInts[3] + isbnInts[4]
                        + 3 * isbnInts[5] + isbnInts[6] + 3 * isbnInts[7] + isbnInts[8] + 3 * isbnInts[9] + isbnInts[10]
                        + 3 * isbnInts[11]) % 10)) % 10) {
                    return true;
                } else {
                    return false;
                ...
                // Validate check digit
                if (isbnInts[9] == (isbnInts[0] + 2 * isbnInts[1] + 3 * isbnInts[2] + 4 * isbnInts[3] + 5 * isbnInts[4]
                        + 6 * isbnInts[5] + 7 * isbnInts[6] + 8 * isbnInts[7] + 9 * isbnInts[8]) % 11) {
                    return true;
                } else {
                    return false;
                }
