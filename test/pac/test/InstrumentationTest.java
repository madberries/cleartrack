...
public class InstrumentationTest {
    ...
    public void testArraysInstrumentation() {
        ...
        Assert.assertFalse("copy of untainted array marked as tainted", ByteArrayTaint.isTainted(byteArray2));
    ...
    public void testReaderInstrumentaiton() {
        ...
        Assert.assertTrue("StringReader input from trusted String not marked trusted", CharArrayTaint.isTrusted(cbuf));
    }
